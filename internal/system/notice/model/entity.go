...
type Notice struct {
	...
	Status      int    `gorm:"column:publish_status;default:0" json:"status"` // 0:草稿 1:已发布 -1:已撤回
	...
	PublisherID int64  `gorm:"column:publisher_id" json:"publisherId"` // 发布人ID
	RevokeTime  string `gorm:"column:revoke_time" json:"revokeTime"` // 撤回时间
	common.BaseEntity
}
